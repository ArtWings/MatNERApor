...
F0 = 1;         % lower frequency limit (or natural frequency of seismograph)
Fs = 100;       % sample rate
N = 5000;       % number of points in frequency vector

n = 2;          % order of the Butterworth filter
e = 1.5;        % allowed deviation from resonant frequences (bandstop of filter: [Fres-e Fres+e])

%------------------------------ Output ------------------------------------
% F             - theoretical water column reduction spectrum 
% f             - corresponding frequency vector (for F spectrum)
...
% ff_compl      - corresponding frequency vector (for hh_compl)
%--------------------------------------------------------------------------
